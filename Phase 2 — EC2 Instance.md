...
Move to the directory where the key was downloaded.
...
This command makes the file read-only for the owner.

---

3. Verify Instance Public IP
...
119.73.101.32/32
5. Fix EC2 Instance Connect Access

AWS console Connect button uses AWS managed IP ranges.
...
7. First Connection Confirmation
